import { api, formatNumber, formatPhone, useSession } from "@agri/core";
import { useQuery } from "@tanstack/react-query";
import {
  AlertTriangle, ArrowRight, Award, CheckCircle2, Clock, Landmark, MapPin, MessageCircle, Plus, ShoppingBag, Sparkles, Sprout, Warehouse, XCircle,
} from "lucide-react";
...
function Interests({ offer }: { offer: Offer }) {
  const q = useQuery({
