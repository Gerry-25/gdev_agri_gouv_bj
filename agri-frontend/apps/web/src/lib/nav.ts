import {
  BookOpen, Coins, Gauge, HeartPulse, Landmark, type LucideIcon, Map, ScanLine, ShieldCheck, ShoppingBasket, Sparkles, Sprout, Warehouse,
} from "lucide-react";
...
export const TABS: Tab[] = [
  ...
  { to: "/finances", label: "Financement & Crédit", short: "Finances", icon: Coins, roles: [...FIELD, ...AGENTS] },
